...
//   const regex = new RegExp(`${coinName}\\s*\\(([^)]*${interval}[^)]*)\\)`);
  
//   const foundMessage = data.messages.find((message) =>
//     regex.test(message.message)
//   );

//   return foundMessage ? { messageID: foundMessage.messageID, chatID: foundMessage.chatID } : null;
// }
